...
class Crafter():
    ...
    def observation_space(self):
        ...
        spaces["is_first"] = gym.spaces.Box(0, 1, (1,), dtype=np.uint8)
        spaces["is_last"] = gym.spaces.Box(0, 1, (1,), dtype=np.uint8)
        spaces["is_terminal"] = gym.spaces.Box(0, 1, (1,), dtype=np.uint8)
        ...
        spaces["target"] = gym.spaces.Box(0, 255, (1,), dtype=np.uint8)
        spaces["navigate_target"] = gym.spaces.Box(0, 255, (1,), dtype=np.uint8)
        spaces["combat_target"] = gym.spaces.Box(0, 255, (1,), dtype=np.uint8)
        spaces["where"] = gym.spaces.Box(0, 1, (len(aware), 4), dtype=np.uint8)
        spaces["front"] = gym.spaces.Box(0, 1, (len(aware) + 1,), dtype=np.uint8)
        spaces["distance"] = gym.spaces.Box(-np.inf, np.inf, (1,), dtype=np.float32)
        spaces["target_do_steps"] = gym.spaces.Box(0, 32767, (1,), dtype=np.int16)
        spaces["target_touch_steps"] = gym.spaces.Box(0, 32767, (1,), dtype=np.int16)
        spaces["target_face_steps"] = gym.spaces.Box(0, 32767, (1,), dtype=np.int16)
        spaces["target_explore_steps"] = gym.spaces.Box(0, 32767, (1,), dtype=np.int16)
        spaces["actor_mode"] = gym.spaces.Box(0, 255, (1,), dtype=np.uint8)
        spaces["prev_target"] = gym.spaces.Box(0, 255, (1,), dtype=np.uint8)
        spaces["prev_navigate_target"] = gym.spaces.Box(0, 255, (1,), dtype=np.uint8)
        spaces["prev_combat_target"] = gym.spaces.Box(0, 255, (1,), dtype=np.uint8)
        ...
        spaces["action"] = gym.spaces.Box(0, 255, (1,), dtype=np.uint8)
        spaces.update({
